...
<body>
<div class="container">
   	<a href="${pageContext.request.contextPath}/gallery/upload_form.do">상품 업로드 하러 가기</a><br/>
   	<a href="${pageContext.request.contextPath}/gallery/ajax_form.do">상품 업로드 하러 가기2</a>
   	<h1>상품 목록 입니다.</h1>
   	<div class="row">
