...
<h1></h1>
    <form action="${pageContext.request.contextPath}/users/signup.do" method="post" class="form-horizontal animate__animated animate__backInLeft" id="myForm">
      ...
      <div class="form-group">
         <label class="control-label col-xs-4" for="profile" style="text-align:left; font-size:17px;">자기소개</label>
      ...
      <div class="form-group">
         <label class="control-label" for="addr" style="text-align:left; font-size:17px;">주소</label>
